...
const addUserModalProps: ModalProps = {modalWithInputText:{
        title: "Add new user",
...
const deleteUserModalProps: ModalProps = {modalWithInputText:{
...
const addChatModalProps: ModalProps = {modalWithInputText:{
    ...
    changeState() {
        ...
        switch (this.props?.store?.state?.messengerState) {
            case MESSENGER_STATE.NEW_CHAT:
                //@ts-ignore
                if (!this.children.modal || this.children?.modal?.children?.modalWithInputText.props.name !== BUTTON_NAME.ADD_CHAT) {
            ...
            case MESSENGER_STATE.ADD_USER:
                // @ts-ignore
                if (!this.children.modal || this.children?.modal?.children?.modalWithInputText.props.name !== BUTTON_NAME.ADD_USER) {
            ...
            case MESSENGER_STATE.DELETE_USER:
                // @ts-ignore
                if (!this.children.modal || this.children?.modal?.children?.modalWithInputText.props.name !== BUTTON_NAME.DELETE_USER) {
